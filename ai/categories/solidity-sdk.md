---
category: Solidity SDK
includes_base_categories: true
base_categories:
- Basics
- Reference
word_count: 72720
token_estimate: 152683
page_count: 35
---
...
Page Title: Get Started with the Solidity SDK

- Resolved Markdown: https://wormhole.com/docs/ai/pages/tools-.solidity-sdk-.get-started.md
- Canonical (HTML): https://wormhole.com/docs/tools/.solidity-sdk/.get-started/
- Summary: Follow this guide to use the Wormhole Solidity SDK's interfaces and tools to help you quickly build on-chain integrations using smart contracts.
- Word Count: 2094; Token Estimate: 3746
...
Page Title: Solidity SDK

- Resolved Markdown: https://wormhole.com/docs/ai/pages/tools-.solidity-sdk-.sdk-reference.md
- Canonical (HTML): https://wormhole.com/docs/tools/.solidity-sdk/.sdk-reference/
- Summary: How to use the Wormhole Solidity SDK for cross-chain messaging, token transfers, and integrating decentralized applications on EVM-compatible blockchains.
- Word Count: 1551; Token Estimate: 2503
