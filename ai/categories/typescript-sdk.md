...
Page Title: Building Protocols and Payloads

- Resolved Markdown: https://wormhole.com/docs/ai/pages/tools-typescript-sdk-guides-protocols-payloads.md
- Canonical (HTML): https://wormhole.com/docs/tools/typescript-sdk/guides/protocols-payloads/
- Summary: Learn how to build, register, and integrate protocols and payloads in the Wormhole TypeScript SDK with type-safe layouts.
- Word Count: 1933; Token Estimate: 3227
...
Page Title: Data Layouts

- Resolved Markdown: https://wormhole.com/docs/ai/pages/tools-typescript-sdk-guides-sdk-layout.md
- Canonical (HTML): https://wormhole.com/docs/tools/typescript-sdk/guides/sdk-layout/
- Summary: Learn how to efficiently define, serialize, and deserialize data structures using Wormhole SDK's layout system for cross-chain communication.
- Word Count: 4140; Token Estimate: 6865
...
Page Title: Get Started with the TypeScript SDK

- Resolved Markdown: https://wormhole.com/docs/ai/pages/tools-typescript-sdk-get-started.md
- Canonical (HTML): https://wormhole.com/docs/tools/typescript-sdk/get-started/
- Summary: Follow this guide to install the Wormhole TypeScript SDK, initialize a Wormhole instance, and add the platforms your integration supports.
- Word Count: 1282; Token Estimate: 2457
...
2. Install dependencies, including the Wormhole TypeScript SDK. This example uses the SDK version `4.7.4`:

   ```bash
   npm install @wormhole-foundation/sdk@4.7.4 -D tsx typescript
   ```
...
Page Title: VAAs and Protocols

- Resolved Markdown: https://wormhole.com/docs/ai/pages/tools-typescript-sdk-guides-vaas-protocols.md
- Canonical (HTML): https://wormhole.com/docs/tools/typescript-sdk/guides/vaas-protocols/
- Summary: Understand how VAAs enable cross-chain messaging and how to handle them using Wormhole's TypeScript and Solidity SDKs.
- Word Count: 815; Token Estimate: 1632
...
Page Title: Wormhole TS SDK

- Resolved Markdown: https://wormhole.com/docs/ai/pages/tools-typescript-sdk-sdk-reference.md
- Canonical (HTML): https://wormhole.com/docs/tools/typescript-sdk/sdk-reference/
- Summary: Explore Wormhole's TypeScript SDK and learn how to perform different types of transfers, including native, token, and USDC.
- Word Count: 5970; Token Estimate: 11003
