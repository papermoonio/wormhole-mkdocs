...
- Resolved Markdown: https://wormhole.com/docs/ai/pages/products-settlement-get-started.md
- Canonical (HTML): https://wormhole.com/docs/products/settlement/get-started/
- Summary: Perform a cross-chain token swap using Wormhole Settlement and the Mayan Swift route with the TypeScript SDK on mainnet.
- Word Count: 1374; Token Estimate: 2411
...
Page Title: Settlement Overview

- Resolved Markdown: https://wormhole.com/docs/ai/pages/products-settlement-overview.md
- Canonical (HTML): https://wormhole.com/docs/products/settlement/overview/
- Summary: Discover how Settlement enables fast, intent-based token transfers across chains using a unified system of solver auctions and integrated execution routes.
- Word Count: 1154; Token Estimate: 1933
...
Page Title: Settlement Protocol Architecture

- Resolved Markdown: https://wormhole.com/docs/ai/pages/products-settlement-concepts-architecture.md
- Canonical (HTML): https://wormhole.com/docs/products/settlement/concepts/architecture/
- Summary: Explore Wormhole Settlement's native swap protocols—Mayan Swift and MCTP—for scalable, efficient cross-chain asset transfers.
- Word Count: 1090; Token Estimate: 1446
...
Page Title: Settlement Supported Networks

- Resolved Markdown: https://wormhole.com/docs/ai/pages/products-settlement-reference-supported-networks.md
- Canonical (HTML): https://wormhole.com/docs/products/settlement/reference/supported-networks/
- Summary: Explore all blockchains supported by Wormhole Settlement, including network availability, block explorers, and cross-chain transfer support.
- Word Count: 584; Token Estimate: 1599
...
Page Title: Wormhole Settlement FAQs

- Resolved Markdown: https://wormhole.com/docs/ai/pages/products-settlement-faqs.md
- Canonical (HTML): https://wormhole.com/docs/products/settlement/faqs/
- Summary: Frequently asked questions about Wormhole Settlement, including smart contract usage, auction fallback, and message execution.
- Word Count: 112; Token Estimate: 135
